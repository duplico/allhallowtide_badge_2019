...
const rgbcolor_t meta_heartcolors_band_frames[][4] = {
    ...
    {{0x0, 0x0, 0xff}, {0x80, 0x0, 0x80}, {0xff, 0x7f, 0xff}, {0x32, 0x66, 0x32}},
...
const rgbcolor_t meta_pair_band_frames[][4] = {
    {{0xff, 0x7f, 0xff}, {0xda, 0x52, 0x20}, {0xff, 0x7f, 0xff}, {0xb2, 0x11, 0x22}},
    {{0xff, 0x7f, 0xff}, {0x20, 0x59, 0xaa}, {0x80, 0x0, 0x80}, {0xb2, 0x11, 0x22}},
    {{0xff, 0x7f, 0xff}, {0xda, 0x52, 0x20}, {0xff, 0x7f, 0xff}, {0x20, 0x59, 0xaa}},
    {{0xb2, 0x11, 0x22}, {0xff, 0x7f, 0xff}, {0x20, 0x59, 0xaa}, {0x80, 0x0, 0x80}},
    {{0x80, 0x0, 0x80}, {0xff, 0x7f, 0xff}, {0xff, 0x7f, 0xff}, {0xb2, 0x11, 0x22}},
};
...
const rgbcolor_t zflag_leather_band_frames[][4] = {
    ...
    {{0x0, 0x0, 0xff}, {0x0, 0x0, 0xff}, {0xf, 0x0, 0x0}, {0x0, 0x0, 0xff}},
    {{0xff, 0x7f, 0xff}, {0xff, 0x7f, 0xff}, {0xf, 0x0, 0x0}, {0xff, 0x7f, 0xff}},
    {{0x0, 0x0, 0x0}, {0x0, 0x0, 0x0}, {0xff, 0x0, 0x0}, {0x0, 0x0, 0x0}},
};
