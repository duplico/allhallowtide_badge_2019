...
// the animation:
const band_animation_t h00geek_girl = {h00geek_girl_band_frames, h00geek_girl_band_durations, h00geek_girl_band_fade_durs, 2, ANIM_TYPE_SOLID, 5};
...
// the animation:
const band_animation_t h01lagoon = {h01lagoon_band_frames, h01lagoon_band_durations, h01lagoon_band_fade_durs, 11, ANIM_TYPE_SOLID, 1};
...
// the animation:
const band_animation_t h02fire = {h02fire_band_frames, h02fire_band_durations, h02fire_band_fade_durs, 5, ANIM_TYPE_FASTTWINKLE, 8};
...
// the animation:
const band_animation_t h03ice = {h03ice_band_frames, h03ice_band_durations, h03ice_band_fade_durs, 5, ANIM_TYPE_FASTTWINKLE, 8};
...
// the animation:
const band_animation_t h04rainbow = {h04rainbow_band_frames, h04rainbow_band_durations, h04rainbow_band_fade_durs, 6, ANIM_TYPE_SOLID, 2};
...
// the animation:
const band_animation_t h05zflag_leather = {h05zflag_leather_band_frames, h05zflag_leather_band_durations, h05zflag_leather_band_fade_durs, 8, ANIM_TYPE_SOLID, 1};
...
// the animation:
const band_animation_t h06zflag_trans = {h06zflag_trans_band_frames, h06zflag_trans_band_durations, h06zflag_trans_band_fade_durs, 7, ANIM_TYPE_SOLID, 2};
...
// the animation:
const band_animation_t h07pan = {h07pan_band_frames, h07pan_band_durations, h07pan_band_fade_durs, 5, ANIM_TYPE_SOLID, 6};
...
// the animation:
const band_animation_t h08zflag_bear = {h08zflag_bear_band_frames, h08zflag_bear_band_durations, h08zflag_bear_band_fade_durs, 8, ANIM_TYPE_SOLID, 3};
...
// the animation:
const band_animation_t h09wiggle = {h09wiggle_band_frames, h09wiggle_band_durations, h09wiggle_band_fade_durs, 2, ANIM_TYPE_SOLID, 5};

///////////////// H10ZFLAG_BI:
// frames for the band:
const rgbcolor_t h10zflag_bi_band_frames[][4] = {
...
const uint16_t h10zflag_bi_band_durations[] = {50, 50, 50, 50, 50, 50, 50, 50, 50, 50};
const uint16_t h10zflag_bi_band_fade_durs[] = {180, 180, 180, 180, 180, 180, 180, 180, 180, 180};
// the animation:
const band_animation_t h10zflag_bi = {h10zflag_bi_band_frames, h10zflag_bi_band_durations, h10zflag_bi_band_fade_durs, 10, ANIM_TYPE_SLOWTWINKLE, 2};
...
const uint16_t h11rainbow2_band_durations[] = {50, 50, 50, 50, 50, 50, 50, 50, 50, 50};
const uint16_t h11rainbow2_band_fade_durs[] = {180, 180, 180, 180, 180, 180, 180, 180, 180, 180};
// the animation:
const band_animation_t h11rainbow2 = {h11rainbow2_band_frames, h11rainbow2_band_durations, h11rainbow2_band_fade_durs, 10, ANIM_TYPE_SLOWTWINKLE, 2};
...
// the animation:
const band_animation_t meta_boop = {meta_boop_band_frames, meta_boop_band_durations, meta_boop_band_fade_durs, 29, ANIM_TYPE_SOLID, 1};
...
// the animation:
const band_animation_t meta_newpair = {meta_newpair_band_frames, meta_newpair_band_durations, meta_newpair_band_fade_durs, 5, ANIM_TYPE_SOLID, 26};
...
// the animation:
const band_animation_t meta_pair = {meta_pair_band_frames, meta_pair_band_durations, meta_pair_band_fade_durs, 4, ANIM_TYPE_SOLID, 16};

const band_animation_t *band_all_anims[15] = {&h00geek_girl, &h01lagoon, &h02fire, &h03ice, &h04rainbow, &h05zflag_leather, &h06zflag_trans, &h07pan, &h08zflag_bear, &h09wiggle, &h10zflag_bi, &h11rainbow2, &meta_boop, &meta_newpair, &meta_pair};
